...
public class Route implements Serializable {
    //select * from tab_route order by count desc limit 0,4 人气旅游
    //select * from tab_route order by rdate desc limit 0,4 最新旅游
    //select * from tab_route where isThemeTour = 1  limit 0,4 最新旅游
